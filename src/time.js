...
export const getHoursLeft = stopTime => pipe(getMomentFromStr,getDurationLeft,getHoursFromDuration,checkLength,checkVal)(stopTime);
...
export const getHoursPassed = startTime => pipe(getMomentFromStr,getDurationPassed,getHoursFromDuration,checkLength,checkVal)(startTime);
